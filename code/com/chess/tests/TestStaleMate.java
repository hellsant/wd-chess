...
public class TestStaleMate {
    ...
    public void testAnandKramnikStaleMate() {
        ...
        Player.makeMove(board, MoveFactory.createMove(board, Board.getCoordinateAtPosition("e4"), Board.getCoordinateAtPosition("f5")));
    ...
    public void testAnonymousStaleMate() {
        ...
        assertFalse(board.currentPlayer().isInStaleMate());
        Player.makeMove(board, MoveFactory.createMove(board, Board.getCoordinateAtPosition("c5"), Board.getCoordinateAtPosition("c6")));
        assertTrue(board.currentPlayer().isInStaleMate());
        assertFalse(board.currentPlayer().isInCheck());
        assertFalse(board.currentPlayer().isInCheckMate());
    }
    ...
    public void testAnonymousStaleMate2() {
        ...
        assertFalse(board.currentPlayer().isInStaleMate());
        Player.makeMove(board, MoveFactory.createMove(board, Board.getCoordinateAtPosition("a6"), Board.getCoordinateAtPosition("a7")));
        assertTrue(board.currentPlayer().isInStaleMate());
        assertFalse(board.currentPlayer().isInCheck());
        assertFalse(board.currentPlayer().isInCheckMate());
    }
