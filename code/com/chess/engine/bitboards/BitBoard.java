...
public class BitBoard {
	...
	private static Map<Integer, ChessBitSet> ALL_FILES = new HashMap<Integer, ChessBitSet>();
	...
	private static Map<Integer, ChessBitSet> ALL_RANKS = new HashMap<Integer, ChessBitSet>();
	...
	static Map<Integer, ChessBitSet> ALL_RIGHT_DIAGONALS = new HashMap<Integer, ChessBitSet>();
	...
	private static Map<Integer, ChessBitSet> ALL_LEFT_DIAGONALS = new HashMap<Integer, ChessBitSet>();
	...
	public BitBoard() {
		...
		boardLegalMoves = new ArrayList<Move>();
	...
	public void printLegalMoves() {
		...
		System.out.println(boardLegalMoves.size() + " legals moves ");

		for (final Move m : boardLegalMoves) {
			System.out.print(m + ",");
		}
